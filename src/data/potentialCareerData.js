...
const RELATED_RING = {
  ...
  Education: ['Education & Teaching', 'Academic Research', 'Operations', 'Other'],
  'Education & Teaching': ['Academic Research', 'Content & Creative Writing', 'Psychology & Counselling', 'Public Relations & Comms'],
  'Academic Research': ['Education & Teaching', 'Economics & Research', 'Data Science', 'Consulting'],
  'Content & Creative Writing': ['Journalism & Media', 'Marketing', 'Digital Marketing', 'Public Relations & Comms'],
  'Journalism & Media': ['Content & Creative Writing', 'Public Relations & Comms', 'Marketing', 'Digital Marketing'],
  'Psychology & Counselling': ['Sociology & Social Work', 'Education & Teaching', 'HR', 'Healthcare Management'],
  'Sociology & Social Work': ['Psychology & Counselling', 'Education & Teaching', 'Consulting', 'Operations'],
  'Economics & Research': ['Business Analytics', 'Finance', 'Academic Research', 'Consulting'],
  'Fine Arts & Design': ['UI/UX', 'Marketing', 'Content & Creative Writing', 'Music & Performing Arts'],
  'Music & Performing Arts': ['Fine Arts & Design', 'Content & Creative Writing', 'Marketing', 'Public Relations & Comms'],
  'Public Relations & Comms': ['Marketing', 'Journalism & Media', 'Content & Creative Writing', 'Strategy'],
