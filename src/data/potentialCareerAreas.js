...
const TEXT_RULES = [
  ...
  { id: 'Marketing', keys: ['marketing', 'brand', 'growth marketing', 'performance marketing', 'content', 'sales', 'bdm', 'business development'] },
  { id: 'Supply Chain Management', keys: ['supply chain', 'logistics', 'scm', 'procurement', 'warehouse', 'fulfillment'] },
  { id: 'Operations', keys: ['operations', 'operat', 'process excellence', 'vendor operations', 'plant ', 'manufacturing'] },
